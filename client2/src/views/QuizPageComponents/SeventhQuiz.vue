    ...
    <div class="BorderGlow">
      <article>
        <div class="quiz-wrap">
          ...
          <div
            class="quiz-main"
            v-for="question in quiz7.questions.slice(x, y)"
            :key="question.id"
            v-show="quizStart"
          >
            <div class="quiz-question">
              <h2>Question {{ y }}/{{ quiz7.questions.length }}</h2>
              <img
...
export default {
  ...
  methods: {
    ...
    nextQuestion() {
      ...
      if (this.quiz7.questions.length - 1 == this.x) {
        this.quizEnd = true
